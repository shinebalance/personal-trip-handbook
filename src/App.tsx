...
export default function App() {
  ...
  return <>
    ...
    <header className="site-header shell">
      <a className="brand" href="#/spots" onClick={reset} aria-label="Seoul Notes"><span className="brand-icon"><BookOpen size={23} strokeWidth={1.6} /></span><span><strong>Seoul <em>notes</em><span>.</span></strong><small>{t.subtitle}</small></span></a>
    ...
    <footer className="site-footer shell"><div><BookOpen size={17} /><span>Seoul <em>notes</em>.</span><span className="footer-divider" />{t.subtitle}</div><details><summary>{t.credits}</summary><p><a href="https://commons.wikimedia.org/wiki/File:Seoul_at_Dusk.jpg" target="_blank" rel="noreferrer">Seoul at Dusk — Markrosenrosen</a> / <a href="https://creativecommons.org/licenses/by-sa/3.0/" target="_blank" rel="noreferrer">CC BY-SA 3.0</a>. Resized; cropped for display.</p></details></footer>
