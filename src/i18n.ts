...
const ja = {
  ...
  completed: 'チェック済み', check: 'チェックする', showCompleted: 'チェック済みだけ', localOnly: 'チェックと★評価はこの端末に保存されます',
  myPriority: '自分の優先度', ratingOptions: ['★ 未設定', '★1', '★2', '★3', '★4 · たぶん行く', '★5 · 行く'], ratingFilterAll: '★ すべて', ratingFilterFour: '★4以上', ratingFilterFive: '★5のみ',
...
const ko: Dictionary = {
  ...
  completed: '체크 완료', check: '체크하기', showCompleted: '체크한 항목만', localOnly: '체크와 별점은 이 기기에 저장됩니다',
  myPriority: '나의 우선순위', ratingOptions: ['★ 미설정', '★1', '★2', '★3', '★4 · 아마 갈 곳', '★5 · 꼭 갈 곳'], ratingFilterAll: '★ 전체', ratingFilterFour: '★4 이상', ratingFilterFive: '★5만',
...
const en: Dictionary = {
  ...
  completed: 'Checked', check: 'Check off', showCompleted: 'Checked only', localOnly: 'Checks and ratings are saved on this device',
  myPriority: 'My priority', ratingOptions: ['★ Not rated', '★1', '★2', '★3', '★4 · Likely to go', '★5 · Going'], ratingFilterAll: '★ All', ratingFilterFour: '★4+', ratingFilterFive: '★5 only',
